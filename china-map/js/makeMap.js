/******/ (function(modules) {
  ...
  \***************************/
    ...
    /***/ function(module, __webpack_exports__, __webpack_require__) {
      ...
      /* harmony import */ var _styleKey_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
        /*! ./styleKey.js */ 1
      );
              ...
              item: function item(classNames, data) {
                ...
                switch (options.widgets[x].type) {
                  case "form":
                    ...
                    keyStyle = Object(
                      _styleKey_js__WEBPACK_IMPORTED_MODULE_0__[
                        /* default */ "a"
                      ]
                    )(styleOptions);
                    break;
  ...
  \****************************/
    ...
    /***/ function(module, __webpack_exports__, __webpack_require__) {
      ...
      /* harmony import */ var _helpers_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
        /*! ./helpers.js */ 0
      );
      ...
      function styleKey(options) {
        ...
        try {
          for (
            var _iterator = map.widgets[Symbol.iterator](), _step;
            ...
            switch (key.form) {
              ...
              case "icon":
                if (key.icon) {
                  ...
                  Object(
                    _helpers_js__WEBPACK_IMPORTED_MODULE_0__[/* load */ "g"]
                  )(key.icon, document.querySelector(".hidden"));
            ...
            if (
              ...
              if (key.form === "div") {
                ...
                divIcon = L.divIcon({
                  className: "icon-div",
                  html:
                    '<span class="text" style="background-color:' +
                    color +
                    '">' +
                    count +
                    "</span>"
              ...
              pointStyle = divIcon
                ? divIcon
                : Object(styleKey["a" /* default */])(styleOptions);
            } else if (
              thisColorKeyWidget &&
      ...
      function styleNonPoint(feature, map, index) {
        ...
        try {
          for (
            ...
            if (
              (forms.length && formKeyForm === "line") ||
              (forms.length && colorKeyForm === "line")
            ) {
              if (formKeyWidget) {
                ...
                if (i > -1) {
                  nonPointStyle = {
                    ...
                    dashArray: helpers["e" /* lineDashArrays */][i]
                      ? helpers["e" /* lineDashArrays */][i][index]
                      : null
                  };
                }
              }
              ...
              switch (true) {
                ...
                case feature.geometry.type.toLowerCase().indexOf("polygon") >
                  -1:
          ...
          Object.keys(row).forEach(function(column, y) {
            if (column.indexOf("gsx$") > -1) {
              ...
              if (columnName === "label") {
                ...
                )(row[Object.keys(row)[y + 2]]["$t"]);
                data.selected = Object(
                  _helpers_js__WEBPACK_IMPORTED_MODULE_0__[
                    /* convertType */ "b"
                  ]
                )(row[Object.keys(row)[y + 3]]["$t"]);
      ...
      function parseWidgetData(metaData) {
        ...
        function process(k, index, property) {
          if (k.toLowerCase().indexOf(property) > -1)
            widgets[index - 1][property] = Object(
              _helpers_js__WEBPACK_IMPORTED_MODULE_0__[/* convertType */ "b"]
            )(metaData[k]);
        }
      ...
      function CustomMap(container, properties) {
        ...
        this.render = function() {
          _this.leaflet = L.map(container, {
            ...
            zoomControl:
              !_this.hasOwnProperty("zoomslider") || _this.zoomslider
                ? false
                : true,
  ...
  \*************************************/
    ...
    /***/ function(module, __webpack_exports__, __webpack_require__) {
      ...
      function makeDocumentNodes(options) {
        ...
        newSectionHTML +=
          '<div id="' + options.slug + '__map" class="map"></div>';
        ...
        if (options.titlecardcontent) {
          var newDialogHTML = "";
          newDialogHTML +=
            '<div class="dialog" id="' + options.slug + '__dialog">';
          newDialogHTML +=
  ...
  \*******************************************/
    ...
    /***/ function(module, __webpack_exports__, __webpack_require__) {
                        ...
                        Promise.all(
                          ...
                          .then(function(jsons) {
                            ...
                            options.widgets.forEach(function(w, x) {
                              ...
                              if (
                                element.querySelector("input[id^='search']")
                              ) {
                                element
      ...
      function handleChange(map, element, widgets, x, count, initialized) {
            ...
            : function(feature, layers) {
                ...
                if (
                  possibleQueries.indexOf(
                    feature.properties[field].toLowerCase()
                  ) > -1 &&
        ...
        if (widgets.length >= x + 1 && initialized >= count)
          Object(makeLayers["a" /* default */])(map);
      }
      ...
      function makeWidgets_asyncGeneratorStep(
        gen,
        resolve,
        reject,
        _next,
                  ...
                  case 0:
                    ...
                    options.widgets.forEach(function(w, x) {
                      ...
                      Array.from(labelText).forEach(function(itemText) {
                        ...
                        var offset =
                          height / parseInt(fontSize.replace("px", ""), 10);
        ...
        switch (options.widgets[x].input) {
          ...
          case "dropdown":
            widgetNodes +=
              ...
              options.widgets[x].instructions +
              '" multiple=""></select>';
            dropdownOptions = Object(helpers["h" /* makeDropdownOptions */])(
              options,
              x
            );
            break;
          ...
          case "checkbox":
            ...
            Object.keys(legendItems).forEach(function(group, i) {
              ...
              widgetNodes +=
                ...
                '" type="checkbox" name="' +
                (options.widgets[x].grouping
                  ? group
                  : legendItems[group][0].value) +
                '" id="' +
                group +
                '" ' +
                ...
                Object(helpers["a" /* capitalize */])(group) +
                "</span></label></li>";
            });
            widgetNodes += "</ul>";
            break;
  ...
  \***************************************/
    ...
    /***/ function(module, __webpack_exports__, __webpack_require__) {
      ...
      /* harmony import */ var _parsers_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
        /*! ./parsers.js */ 3
      );
      /* harmony import */ var _makeWidgets_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
        /*! ./makeWidgets.js */ 6
      );
      /* harmony import */ var _makeDocumentNodes_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
        /*! ./makeDocumentNodes.js */ 5
      );
      function asyncGeneratorStep(
        gen,
        resolve,
                      ...
                      new Promise(function(resolve, reject) {
                        return fetch(
                          ...
                          .then(function(json) {
                            ...
                            Object(
                              _makeDocumentNodes_js__WEBPACK_IMPORTED_MODULE_2__[
                                /* default */ "a"
                              ]
                            )(properties);
                                            ...
                                            while (1) {
                                              switch (
                                                ...
                                                case 0:
                                                  _context.next = 2;
                                                  return Object(
                                                    _makeWidgets_js__WEBPACK_IMPORTED_MODULE_1__[
                                                      /* default */ "a"
                                                    ]
                                                  )(
                                                    jsons,
                                                ...
                                                case 2:
                                                  ...
                                                  if (
                                                    properties.footer &&
                                                    properties.footer.trim()
                                                  ) {
                                                    footerNode = document.createElement(
                                                      "footer"
                                                    );
  ...
  \****************************/
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      var update = __webpack_require__(
        /*! ../../node_modules/style-loader/lib/addStyles.js */ 10
      )(content, options);
...
*/
  ...
  \******************************************/
    ...
    /***/ function(module, __webpack_exports__, __webpack_require__) {
      ...
      /* harmony import */ var _makeDocumentNodes_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
        /*! ./makeDocumentNodes.js */ 5
      );
      /* harmony import */ var _makeLayers_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
        /*! ./makeLayers.js */ 2
      );
      /* harmony import */ var _makeWidgets_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
        /*! ./makeWidgets.js */ 6
      );
      /* harmony import */ var _CustomMap_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
        /*! ./CustomMap.js */ 4
      );
      function asyncGeneratorStep(
        gen,
      ...
      window.makeLayers =
        _makeLayers_js__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"];
              ...
              while (1) {
                switch ((_context2.prev = _context2.next)) {
                  case 0:
                    ...
                    Object(
                      _makeDocumentNodes_js__WEBPACK_IMPORTED_MODULE_0__[
                        /* default */ "a"
                      ]
                    )(options);
                    container = document.querySelector(
                      "#" + options.slug + "__map.map"
                    );
                    ...
                    map = new _CustomMap_js__WEBPACK_IMPORTED_MODULE_3__[
                      /* default */ "a"
                      ...
                      new Promise(function(resolve, reject) {
                        return fetch(
                          ...
                          .then(function(json) {
                            ...
                            Object(
                              _makeLayers_js__WEBPACK_IMPORTED_MODULE_1__[
                                /* default */ "a"
                              ]
                            )(map);
                            resolve(map);
                                      ...
                                      while (1) {
                                        switch (
                                          ...
                                          case 0:
                                            ...
                                            _context.next = 6;
                                            return Object(
                                              _makeWidgets_js__WEBPACK_IMPORTED_MODULE_2__[
                                                /* default */ "a"
                                              ]
                                            )(
                                              options.json,
        ...
        return new Promise(function(resolve, reject) {
          secondaryJsFiles.forEach(function(file) {
            ...
            jsLink.onload = function() {
              ...
              if (
                leafletLoaded ===
                secondaryJsFiles.length + primaryJsFiles.length
              ) {
            ...
            return regeneratorRuntime.wrap(function _callee5$(_context5) {
              while (1) {
                switch ((_context5.prev = _context5.next)) {
                              ...
                              return regeneratorRuntime.wrap(function _callee4$(
                                ...
                                while (1) {
                                  switch ((_context4.prev = _context4.next)) {
                                    case 0:
                                      translations = Object(
                                        parsers["a" /* parseLanguageData */]
                                      )(json.feed.entry);
                                      initWithSpreadsheet = __webpack_require__(
                                        /*! ./initWithSpreadsheet.js */ 7
                                      ).default;
                                      _context4.next = 4;
                                      return initWithSpreadsheet(
                                        dataURL,
                  ...
                  case 13:
                    initWithoutSpreadsheet = __webpack_require__(
                      /*! ./initWithoutSpreadsheet.js */ 13
                    ).default;
                    _context5.next = 16;
